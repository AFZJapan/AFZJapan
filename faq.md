...
<a href="#cant-boycott-everything">7．全部ボイコットできなくてもAFZに登録できる？</a><br/>
</p>

<br/>

<p>
<a id="whats-afz"><h6><span style="font-weight: 700;">1．AFZsって何？</span></h6></a>
...
<p>
<a id="who-can-join"><h6><span style="font-weight: 700;">2．誰が参加できるの？</span></h6></a>

地域のビジネス（飲食店、書店、小売店など）、学術的・文化的なスペース（大学、研究室、劇場など）、イベント（音楽祭、クラブイベント、芸術祭など）や自治体（町内会、市議会など）をはじめとする様々な空間やイベントを対象としています。<br/><br/>
</p>

<p>
<a id="whats-bds"><h6><span style="font-weight: 700;">3．BDS運動って何？</span></h6></a>
...
<p>
<a id="what-can-you-do"><h6><span style="font-weight: 700;">4．何をすればいいの？</span></h6></a>
...
<p>
<a id="antizionism-is-not-antisemitism"><h6><span style="font-weight: 700;">5．反ユダヤ主義ではないの？</span></h6></a>
...
<p>
<a id="how-does-it-connect"><h6><span style="font-weight: 700;">6．パレスチナの解放にどう繋がるの？</span></h6></a>
...
アパルトヘイト・フリー・ゾーンを宣言する自治体やコミュニティ、組織が増えるにつれ、真に深い連帯の文化が築かれていきます。<br/><br/>
</p>

<p>
<a id="#cant-boycott-everything"><h6><span style="font-weight: 700;">7．全部ボイコットできなくてもAFZに登録できる？</span></h6></a>

私たちのキャンペーンは、BNC(パレスチナBDS民族評議会)が虐殺への加担度とボイコット効果の両面を考えた「戦略的ボイコット」を推奨しています（＊リスト参照）。また特に、生活や仕事をする上でボイコットが難しい企業は「圧力対象」に入っています。圧力対象の企業は代替サービスに移行することが推奨されますが、すぐに切り替えることが難しい場合、以下のようなアクションを取りながらAFZに登録して頂くことができます。<br/><br/>

・現在のサービスを使いながらも、顧客、ユーザーとして、その企業が虐殺に加担することを辞めて欲しい旨、要望メッセージを送る。（ボイコットはあくまで虐殺加担を辞めてもらうための要求手段のひとつであり、加担がなくなればまた気持ちよく使えるようになることを念頭に置きましょう）<br/>
・AFZ賛同店・スペースであることを、ウェブサイトやソーシャルメディア、店頭などで意思表示する。<br/>
・虐殺に加担していない代替サービスについて調べたり、段階的に移行したりするなど、虐殺フリーなサービスを使うための準備や努力を行う。
</p>
